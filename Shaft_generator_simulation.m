...
% battery data
BATTERY_CAPACITY = 2032.34 *3600; % [kJ]
C_rate_dis = 4;
C_rate_cha = 3;
MAX_DISCHARGING_POWER =  BATTERY_CAPACITY*C_rate_dis; % [kW]
MAX_CHARGING_POWER =  BATTERY_CAPACITY*C_rate_cha; % [kW]
...
[FFR_23_ME,Power_23_ME,A1_low_23_ME,A1_high_23_ME,A0_low_23_ME,A0_high_23_ME] = FFR_85_alt(Load_ME,SFOC_ME,MAX_ME_POWER_2); % evaluation of the SFOC minimum and of the angular coefficients
...
Consumption_AE = xlsread('HFO_SFOC_AE'); 
...
[FFR_23_AE,Power_23_AE,A1_low_23_AE,A1_high_23_AE,A0_low_23_AE,A0_high_23_AE] = FFR_85_alt(Load_AE,SFOC_AE,MAX_AE_POWER2); % evaluation of the SFOC minimum and of the angular coefficients
...
powerBalanceCons_ME = sum(P_low (:,[1:4]) + P_high (:,[1:4]), 2) - P_shaft  >= Power_prop_demand;
...
MinShaftPower = P_shaft >= MIN_SHAFT_POWER;
...
ylabel('Power [kW]')
xlabel('Time [h]')
title('Optimised auxiliary motors and battery with shaft generator')
xlim([0 t_end/3600])
grid on
grid minor
