...
xlabel('Power [kW]') 
ylabel('FFR [g/s]') 
title('Fuel flow rate from data - ME, P max 8125 kW')
grid on
figure 
...
xlabel('Power [kW]') 
ylabel('FFR [g/s]') 
title('Fuel flow rate from data - ME, P max 7500 kW')
grid on
...
title('Interpolated FFR for ME, P max 8125 kW')
...
xlim([0 100]);
grid on
title ('Interpolated SFOC for ME')
...
xlabel('Power [kW]');
ylabel('Fuel flow rate [g/s]');
title('Interpolated FFR for ME, P max 7500 kW')
